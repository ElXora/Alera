...
export default function LocationsSection() {
    ...
    const globeConfig = useMemo(() => ({
        ...
        mapSamples: 16000,
        mapBrightness: 3,
        baseColor: [0.08, 0.09, 0.15] as [number, number, number], 
        markerColor: [0.333, 1.0, 0.267] as [number, number, number], 
        glowColor: [0.08, 0.3, 0.08] as [number, number, number], 
        markers: locations
                ...
                <div className="grid lg:grid-cols-2 gap-6 sm:gap-10 lg:gap-16 items-center">
                    ...
                    >
                        <h2 className="text-xl sm:text-2xl lg:text-4xl xl:text-5xl orbitron-font font-bold text-gray-900 dark:text-white mb-3 sm:mb-4 leading-tight">
                            India-Based,
                            <br />
                            <span className="icon-text-primary">Built for Low Latency</span>
                        </h2>
                        ...
                        <p className="text-gray-600 dark:text-gray-300 text-xs sm:text-sm lg:text-base mb-4 sm:mb-6 lg:mb-8 leading-relaxed max-w-xl">
                            We currently host exclusively from India, giving players and bot owners across the
                            region the lowest possible ping. More locations are on the roadmap &mdash; stay tuned.
                        </p>

                        <div className="grid grid-cols-1 sm:max-w-xs gap-4 sm:gap-6 lg:gap-8">
                            <div>
