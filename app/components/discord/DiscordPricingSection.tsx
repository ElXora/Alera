    ...
    <div className="bg-gray-50 dark:bg-[#0a0b0f] relative py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="relative z-10 mt-16 max-w-7xl mx-auto">
        ...
        >
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4 mb-4">
            <div className="flex-1">
              <div className="inline-flex items-left gap-2 bg-[#55FF44] dark:bg-[#55FF44]/20 px-4 py-2 rounded-tl-2xl rounded-br-2xl mb-4 border border-[#55FF44]/20 dark:border-[#55FF44]/20">
                <span className="text-[#55FF44] dark:text-[#55FF44] text-sm">{t('discord.badge')}</span>
              </div>
              <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4 orbitron-font">
                {t('discord.title').split(" ").slice(0, -1).join(" ")}{" "}
                <span className="text-[#55FF44] dark:text-[#55FF44] relative">
                  {t('discord.title').split(" ").slice(-1)[0]}
                  <motion.svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 1418 125"
                    className="absolute left-0 w-full text-[#55FF44]"
              ...
              <p className="text-md text-gray-600 max-w-3xl dark:text-gray-300">{t('discord.description')}</p>
            </div>
            <CurrencySelector
        ...
        <motion.div
          ...
          className="flex items-center gap-3 mb-8 px-4 py-3 rounded-lg bg-yellow-500/10 border border-yellow-500/30"
        >
          ...
          <span className="text-sm text-yellow-600 dark:text-yellow-400">
            Sorry, we&apos;re currently experiencing a CPU shortage &mdash; CPU allocation on Discord Bot plans will be a little lower than usual until stock is restored.
          </span>
        </motion.div>
        ...
        >
          <div className="flex flex-col items-left">
            <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">{t('discord.step1')}</h3>
              ...
              {config.planTypes.map((planType) => (
                <button
                  ...
                  className={`flex items-center gap-3 px-4 backdrop-blur-sm py-2 rounded-tl-2xl rounded-br-2xl font-medium transition-all duration-300 ${selectedPlanType === planType.id
                      ? "bg-[#55FF44] dark:bg-[#55FF44]/40 dark:text-[#55FF44] text-white shadow-lg"
                      : "bg-gray-200 dark:bg-gray-800/20 dark:border-[#55FF44]/40 border border-[#55FF44]/20 text-gray-700 dark:text-[#55FF44] hover:bg-[radial-gradient(50%_50%_at_50%_100%,_rgba(85, 255, 68,0.15)_0%,_transparent_100%)] dark:hover:bg-[radial-gradient(50%_50%_at_50%_100%,_rgba(85, 255, 68,0.25)_0%,_transparent_100%)]"
                    }`}
                >
                  <Image
        ...
        <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">{t('discord.step2')}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {currentPlans.map((plan, index) => (
              <motion.div
                ...
                className="relative bg-white/20 dark:bg-gray-900/20 backdrop-blur-xl rounded-md overflow-hidden border border-[#55FF44]/20 dark:border-[#55FF44]/20 hover:border-[#55FF44] dark:hover:border-[#55FF44]/50 hover:bg-[radial-gradient(50%_50%_at_50%_100%,_rgba(85, 255, 68,0.15)_0%,_transparent_100%)] dark:hover:bg-[radial-gradient(50%_50%_at_50%_100%,_rgba(85, 255, 68,0.25)_0%,_transparent_100%)] transition-all duration-300"
              >
                {plan.badge && (
                  <div className="absolute top-4 right-4">
                    <span className="px-3 py-1 text-xs font-medium text-white bg-[#55FF44] rounded-tl-2xl rounded-br-2xl">
                      {plan.badge}
                    </span>
                  </div>
                )}
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="flex flex-col gap-1">
                      <div className="flex items-center gap-2">
                        <Cpu className="w-4 h-4 text-[#55FF44] dark:text-[#55FF44]" />
                    ...
                    <div className="flex flex-col gap-1">
                      <div className="flex items-center gap-2">
                        <MemoryStick className="w-4 h-4 text-[#55FF44] dark:text-[#55FF44]" />
                    ...
                    <div className="flex flex-col gap-1">
                      <div className="flex items-center gap-2">
                        <HardDrive className="w-4 h-4 text-[#55FF44] dark:text-[#55FF44]" />
                    ...
                    <div className="flex flex-col gap-1">
                      <div className="flex items-center gap-2">
                        <Wifi className="w-4 h-4 text-[#55FF44] dark:text-[#55FF44]" />
                  ...
                  <div className="flex items-center gap-2 mb-6">
                    <HeartPulse className="w-4 h-4 text-[#55FF44] dark:text-[#55FF44]" />
                  ...
                  <div className="mt-6">
                    ...
                    <a
                      href={plan.orderLink}
                      className="orbitron-font w-full bg-[#55FF44] hover:bg-[#55FF44] dark:bg-[#55FF44]/20 text-white dark:text-[#55FF44] px-6 py-3 rounded-lg font-medium transition-colors duration-300 flex items-center justify-center gap-2"
                    >
                      {t('common.orderNow')}
